<?php
    ...
    // check if minimal image dimension requirements are met - return true if they are.
    function checkFileDimensions($min_width, $min_height, $file) {
        list($originalWidth, $originalHeight, $tpe, $attr) = getimagesize($file);
