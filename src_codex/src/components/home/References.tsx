...
import { homeReferences } from '../../data/references'
    ...
    <section id="referencie" className="scroll-mt-20 bg-navy py-20 text-white sm:py-24 lg:py-28" aria-labelledby="references-title">
      <div className="site-container">
        <div className="flex flex-col gap-7 sm:flex-row sm:items-end sm:justify-between">
          ...
          <Link to="/referencie" className="button-outline-light hidden sm:inline-flex">
            Všetky referencie
        ...
        <div className="mt-9 sm:hidden">
          <Link to="/referencie" className="button-outline-light w-full">
            Všetky referencie
            <ArrowRight className="h-4 w-4" aria-hidden="true" />
          </Link>
        </div>
